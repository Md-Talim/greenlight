...
// editConflictResponse sends a 409 Conflict response along with error message
...
// invalidAuthenticationTokenResponse sends a 401 Unauthorized response and an error message.
// It also sets the WWW-Authenticate header value to Bearer
...
// authenticationRequiredResponse sends 401 Unauthorized response and an error message
